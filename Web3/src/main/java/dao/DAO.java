...
public class DAO {
	...
	public void addProduct(int id, String productName, String productCategoryPath, String img, double unitPrice, double oldPrice, int cid, int quantity) {
        String query = "INSERT INTO product (id, productName, productCategoryPath, img, unitPrice, oldPrice, cid, quantity) " +
                       "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            new DBContext();
            connect = DBContext.getConnection();
            ...
            prepare.setString(3, productCategoryPath);
            prepare.setString(4, img);
            prepare.setDouble(5, unitPrice);
            prepare.setDouble(6, oldPrice);
            prepare.setInt(7, cid);
